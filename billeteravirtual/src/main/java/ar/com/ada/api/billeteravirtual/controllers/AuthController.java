...
public class AuthController {
    ...
    public ResponseEntity<?> createAuthenticationToken(@RequestBody LoginRequest authenticationRequest)
         ...
         * 
         * LoginResponse r = new LoginResponse(); r.id = u.getUsuarioId(); r.billeteraId
         * = u.getPersona().getBilletera().getBilleteraId(); r.username =
         * authenticationRequest.username; r.email = u.getEmail(); r.token = token;
         */
        // return ResponseEntity.ok(r);
